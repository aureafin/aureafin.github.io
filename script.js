...
(() => {
  ...
  /* ------------------------------------------------------
     10c. PUBLICIDADE (pronto para o AdsTerra)
     Este modal abre sozinho depois de cada tarefa/Super Tarefa,
     mas só quando #adSlotTask já tiver o código do anúncio dentro.
     Enquanto o espaço estiver vazio, nada é mostrado.
     ------------------------------------------------------ */
  function showTaskAd() {
